...
| [0009](./0009-retain-dormant-remote-mcp.md)                          | Remote MCP code — fail-closed 休眠コードとして温存                                    | Accepted | #142    |
...
> ADR 0009 は #142 で起票した後続 ADR: remote 公開トラック見送り後も HTTP/Auth コードを
> fail-closed な休眠コードとして温存する現行方針を固定する。
